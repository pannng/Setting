...
namespace VRTK
{
    ...
    public class VRTK_PanelMenuItemController : MonoBehaviour
    {
        ...
        /// </summary>
        /// <param name="interactableObject">The object the menu is attached to.</param>
        public virtual void GripPressed(GameObject interactableObject)
        {
            OnPanelMenuItemGripPressed(SetPanelMenuItemEvent(interactableObject));
        }

        protected virtual void OnPanelMenuItemGripPressed(PanelMenuItemControllerEventArgs e)
        {
            if (PanelMenuItemGripPressed != null)
            {
                PanelMenuItemGripPressed(this, e);
            }
        }
    }
}