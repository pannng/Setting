namespace VRTK.Examples.PanelMenu
{
    ...
    public class PanelMenuUIGrid : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            GetComponentInParent<VRTK_PanelMenuItemController>().PanelMenuItemGripPressed += new PanelMenuItemControllerEventHandler(OnPanelMenuItemGripPressed);
        ...
        private void OnPanelMenuItemGripPressed(object sender, PanelMenuItemControllerEventArgs e)
        {
